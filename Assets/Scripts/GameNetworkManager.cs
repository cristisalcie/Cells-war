...
public class GameNetworkManager : NetworkManager
{
    ...
    {
        Debug.Log("GameNetworkManager.OnStartAction invoked");
    }
    ...
    /// </summary>
    protected override void CalculateConnectionQuality()
    {
    ...
    protected override void OnConnectionQualityChanged(ConnectionQuality previous, ConnectionQuality current)
    {
    ...
    public override Transform GetStartPosition()
    {
        ...
        float _newPositionX = UnityEngine.Random.Range
            (
                -mapBordersTransform.localScale.x / 2 + playerPrefab.transform.localScale.x / 2,
                mapBordersTransform.localScale.x / 2 - playerPrefab.transform.localScale.x / 2
            );
        float _newPositionY = UnityEngine.Random.Range
            (
                -mapBordersTransform.localScale.y / 2 + playerPrefab.transform.localScale.y / 2,
                mapBordersTransform.localScale.y / 2 - playerPrefab.transform.localScale.y / 2
            );

        Transform _startPosition = startPositions[0];
        _startPosition.position = new Vector3(_newPositionX, _newPositionY, 0);
